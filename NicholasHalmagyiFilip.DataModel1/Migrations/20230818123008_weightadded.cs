        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CountryDepotId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DrugUnitId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DrugUnitPickNumber = table.Column<int>(type: "int", nullable: false),
                    DrugUnitDepotId = table.Column<int>(type: "int", nullable: true),
                    DrugUnitDrugTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
